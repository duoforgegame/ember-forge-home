...
const en: Dict = {
  ...
  deleteDraftBody: "Are you sure you want to delete this skin? This action cannot be undone.",
  ...
  noApprovedSkins: "You have no approved skins yet. Once the team approves a skin, it shows up here.",
...
const de: Dict = {
  ...
  deleteDraftBody: "Bist du sicher, dass du diesen Skin löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden.",
  ...
  noApprovedSkins: "Du hast noch keine freigegebenen Skins. Sobald das Team einen Skin freigibt, erscheint er hier.",
...
const zh: Dict = {
  ...
  deleteDraftBody: "确定要删除这个皮肤吗？此操作无法撤销。",
  ...
  noApprovedSkins: "你还没有通过审核的皮肤。审核通过后会显示在这里。",
...
const ja: Dict = {
  ...
  deleteDraftBody: "このスキンを削除してもよろしいですか。この操作は元に戻せません。",
  ...
  noApprovedSkins: "承認されたスキンはまだありません。承認されるとここに表示されます。",
