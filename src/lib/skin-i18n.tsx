...
const en: Dict = {
  ...
  addCurrentColour: "Add current colour",
  savePalette: "Save palette",
  paletteSaved: "Palette saved",
  paletteDeleted: "Palette deleted",
  noSavedPalettes: "No saved palettes yet.",
  signInToSavePalettes: "Sign in to save your own colour palettes.",
  addColoursFirst: "Add at least one colour first",
  paletteNameRequired: "Please name your palette",
  deletePalette: "Delete palette",
  deletePaletteTitle: "Delete this palette?",
  deletePaletteBody: "Are you sure you want to delete this palette? This action cannot be undone.",
...
const de: Dict = {
  ...
  myPalettes: "Meine Paletten",
  paletteNamePlaceholder: "Palettenname",
  addCurrentColour: "Aktuelle Farbe hinzufügen",
  savePalette: "Palette speichern",
  paletteSaved: "Palette gespeichert",
  paletteDeleted: "Palette gelöscht",
  noSavedPalettes: "Noch keine gespeicherten Paletten.",
  signInToSavePalettes: "Melde dich an, um eigene Farbpaletten zu speichern.",
  addColoursFirst: "Füge zuerst mindestens eine Farbe hinzu",
  paletteNameRequired: "Bitte gib deiner Palette einen Namen",
  deletePalette: "Palette löschen",
  deletePaletteTitle: "Diese Palette löschen?",
  deletePaletteBody: "Bist du sicher, dass du diese Palette löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden.",
  currentColours: "Aktuelle Farben",
  helpMasked:
...
const zh: Dict = {
  ...
  brightness: "亮度",
  myPalettes: "我的调色板",
  paletteNamePlaceholder: "调色板名称",
  addCurrentColour: "添加当前颜色",
  savePalette: "保存调色板",
  paletteSaved: "调色板已保存",
  paletteDeleted: "调色板已删除",
  noSavedPalettes: "还没有保存的调色板。",
  signInToSavePalettes: "登录后即可保存自己的调色板。",
  addColoursFirst: "请先添加至少一种颜色",
  paletteNameRequired: "请为你的调色板命名",
  deletePalette: "删除调色板",
  deletePaletteTitle: "删除这个调色板吗？",
  deletePaletteBody: "确定要删除这个调色板吗？此操作无法撤销。",
  currentColours: "当前颜色",
  helpMasked:
...
const ja: Dict = {
  ...
  brightness: "明るさ",
  myPalettes: "マイパレット",
  paletteNamePlaceholder: "パレット名",
  addCurrentColour: "現在の色を追加",
  savePalette: "パレットを保存",
  paletteSaved: "パレットを保存しました",
  paletteDeleted: "パレットを削除しました",
  noSavedPalettes: "保存されたパレットはまだありません。",
  signInToSavePalettes: "ログインすると自分のパレットを保存できます。",
  addColoursFirst: "まず色を1つ以上追加してください",
  paletteNameRequired: "パレット名を入力してください",
  deletePalette: "パレットを削除",
  deletePaletteTitle: "このパレットを削除しますか？",
  deletePaletteBody: "このパレットを削除してもよろしいですか？この操作は取り消せません。",
  currentColours: "現在の色",
  helpMasked:
